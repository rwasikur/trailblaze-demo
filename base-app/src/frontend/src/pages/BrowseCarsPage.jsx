    ...
    return (
        <div className="min-h-full bg-slate-50">
            <div className="mx-auto w-full max-w-7xl px-6 pt-4 pb-8">
                ...
                <div className="mb-8 mx-auto max-w-4xl flex items-center bg-white border-2 border-slate-100 rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.15)] p-2 focus-within:ring-8 focus-within:ring-blue-600/10 focus-within:border-blue-600/20 transition-all duration-500 relative">
                    ...
                    <div className="hidden lg:flex items-center px-8 border-l border-slate-100 text-[11px] font-black text-slate-500 uppercase tracking-[0.2em]">
                        <span className="text-blue-600 mr-2 text-base">{filteredCars.length}</span> Available
                    </div>
                </div>
