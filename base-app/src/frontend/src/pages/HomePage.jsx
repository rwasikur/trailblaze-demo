        ...
        <div style={{
            ...
            <div style={{ zIndex: 1, textAlign: 'center', position: 'absolute', top: '10vh', width: '100%', padding: '0 2rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <button
                    ...
                    style={{ marginTop: '3rem', background: '#ffffff', color: '#111111', fontSize: '0.9rem', padding: '0.8rem 2.5rem', borderRadius: '12px', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 700, boxShadow: '0 4px 15px rgba(0, 0, 0, 0.4)' }}>
                    Explore Cars
