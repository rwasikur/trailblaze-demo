        ...
        <div className="min-h-full bg-slate-50 py-10 px-6">
            <div className="max-w-7xl mx-auto space-y-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <h1 id="analytics-dashboard-heading" className="text-3xl font-extrabold text-slate-900 font-display tracking-tight">
                            Analytics Dashboard
                        </h1>
                        <p className="text-slate-500 mt-2 text-base">
                            Review fleet health, availability, revenue, and inventory mix.
                        </p>
                    </div>
