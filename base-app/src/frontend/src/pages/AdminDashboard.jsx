                                            ...
                                            <tbody id="dashboard-car-list" className="divide-y divide-slate-50">
                                                {cars.map(car => (
                                                    <tr id={`car-row-${car._id}`} key={car._id} className="hover:bg-slate-50/30 transition-colors group">
                                                        ...
                                                        <td className="px-6 py-5 text-slate-900 font-black text-sm">Rs. {car.price?.toLocaleString()}</td>
                                                        <td className="px-6 py-5">
                                                ...
                                                {bookings.map(booking => (
                                                    <tr key={booking._id} className="hover:bg-slate-50/30 transition-colors">
                                                        ...
                                                        <td className="px-6 py-5">
                                                            ...
                                                            <div className="text-[10px] font-bold text-blue-600 uppercase tracking-widest mt-0.5">Rs. {booking.car?.price?.toLocaleString()}</div>
                                                        </td>
